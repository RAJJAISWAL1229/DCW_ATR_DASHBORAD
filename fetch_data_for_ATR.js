...
async function fetch_Data_for_atr(startDateInput, endDateInput, productValue) {
    try {
        ...
        const fetch_Data = parsedData[0][`${products}_1D`].DATA.reduce((acc, entry) => {
            ...
            startDate.setDate(startDate.getDate() - 20); // Adjust start date by subtracting 50 days
